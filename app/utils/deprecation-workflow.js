...
const SILENCED_DEPRECATIONS = [
  ...
  'ember-power-select.deprecate-power-select-multiple', // Needs to be resolved in ember-submission-form-fields
  'ember-power-select.deprecate-power-select-multiple-trigger',
  'ember-power-select.deprecate-power-select-multiple-input',
];
